...
```markdown
<div align="center">
  <img src="https://blogger.googleusercontent.com/img/a/AVvXsEjiOoSuMMmUakxLDOSNtXiJtzYe8BhR8Yy9g6mE6bTsEJNFru_n7E6fri7_VB-zarxqQmLZOUo3g4llrx7ZIqz-6uj8T58YgxDzZ4ZLqfME_Y4zXisuLhDEhgIDKKe3e3eaDQ5avWmncc0cx5cMfsxwiXu3bgsPrCvBGLOMynNacdX1YOTGPNJG7TOmIx0=s576" alt="Mahanaim" width="300" style="border-radius: 12px; border: 3px solid #d4ac0d;">
...
### ¿Por qué esta versión sí se va a ver bien?
1. **No tiene bloques de código largos** (eliminé los triples backticks que se borran al copiar).
2. **Usa tablas y negritas** para mostrar los ejemplos, lo cual es a prueba de errores al copiar y pegar.
3. **Mantengo el HTML del encabezado intacto** al principio (eso es lo que dibuja el logo, los badges y lo centra).
